...
| ไฟล์ | หน้าที่ |
|---|---|
| `public/liff/jot/index.html` | โครงหน้า + `<template>` ของรายการหนึ่งใบ |
| `public/liff/jot/style.css` | สีทั้งหมดอยู่ใน `:root` บล็อกเดียว แก้ที่นั่นที่เดียว |
| `public/liff/jot/script.js` | สถานะ การคำนวณ รูป และการยิง API |

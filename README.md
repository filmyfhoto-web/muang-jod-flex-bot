...
ปลั๊กอิน Illustrator + Photoshop สำหรับงานสติ๊กเกอร์ มี 3 เครื่องมือ: **จัดวางดวง** ตามเส้นไดคัทจริง · **ไดคัทต่อเนื่อง** (ต้นแบบเดียวเต็มแผ่น เส้นตัดยาว ยกใบมีดน้อย) · **ไดคัทตามรูปทรง** (เส้นแดงรอบเวกเตอร์/Clipping Mask/รูป JPG-PNG) — สร้างชีตบนอาร์ตบอร์ดใหม่ แยกเลเยอร์งานพิมพ์/เส้นไดคัท ใส่มาร์กและหัวงาน

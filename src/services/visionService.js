  ...
  "items": [
    {
      ...
      "size": string | null,       // ขนาด เช่น "3.5x4.0 ซม." ถ้าไม่มีให้ null
      "quantity": number,          // จำนวน ถ้าไม่ระบุให้ 1
      "unit": string | null,       // หน่วย เช่น "อัน" "ตร.ม." ถ้าไม่มีให้ null
...
- ขนาดให้คงหน่วยตามที่เขียนในเอกสาร เช่น "3.5x4.0 ซม."
- ถ้าเอกสารบอกราคาเป็นตารางเมตร ให้คำนวณพื้นที่เอง แล้วส่ง quantity = ตร.ม. รวม,
  unit = "ตร.ม.", unit_price = ราคาต่อตารางเมตร

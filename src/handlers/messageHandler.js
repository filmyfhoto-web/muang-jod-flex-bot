...
async function startCollectFlow(replyToken, profile, collecting) {
...
async function finishCollect(replyToken, profile, collecting) {
...
async function handleCollectTurn(replyToken, profile, state, text) {

  ...
  const body = [
    {
      ...
      contents: [
        ...
        },
        {
          ...
          layout: 'vertical',
          contents: [
            { type: 'text', text: 'บันทึกจากหลักฐานสำเร็จ', weight: 'bold', size: 'lg', color: COLORS.purpleDark, wrap: true },
    ...
    field('💰', 'ยอดชำระ', formatBaht(Number(job.total) || 0), { big: true, color: COLORS.purple }),
